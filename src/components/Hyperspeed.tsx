...
class CarLights {
  ...
  init() {
    ...
    const instanced = new THREE.InstancedBufferGeometry().copy(geometry as unknown as THREE.BufferGeometry);
...
class App {
  ...
  loadAssets(): Promise<void> {
    ...
    return new Promise(resolve => {
      ...
      assets.smaa = { search: searchImage, area: areaImage };
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  return <div id="lights" style={{ width: '100%', height: '100%' }} ref={hyperspeed} />;
};
